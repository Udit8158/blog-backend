...
| Method  | Endpoint                                   | Description                    | Notes                                         | Request Body                                 |
| ------- | ------------------------------------------ | ------------------------------ | --------------------------------------------- | -------------------------------------------- |
...
| `POST`  | `/api/v1/admin/blogs`                      | Create a new blog              | -                                             | `{ "title": "string", "content": "string" }` |
| `PUT`   | `/api/v1/admin/blogs/:blogId`              | Update a specific blog         | Requires blog ID parameter                    | `{ "title": "string", "content": "string" }` |
...
| `POST`  | `/api/v1/upload/upload-image`              | Upload image                   | -                                             | -                                            |
